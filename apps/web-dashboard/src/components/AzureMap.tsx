...
export const AzureMap: React.FC<AzureMapProps> = ({
    ...
    // Center Update - only on initial load
    useEffect(() => {
        // Only set initial position, don't reset on prop changes to allow user interaction
        if (mapInstance && center && !mapInstance.getCamera().center) {
