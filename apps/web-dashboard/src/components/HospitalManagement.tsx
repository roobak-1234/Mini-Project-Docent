...
import { Building2, Users, ArrowLeft, User, Mail, Phone, UserCheck, Truck } from 'lucide-react';
...
const HospitalManagement: React.FC<HospitalManagementProps> = ({ onBack }) => {
      ...
      if (doctorHospital?.uniqueHospitalId) {
        const refreshData = () => {
          ...
          if (ambulanceStaff.length > 0) {
            ...
            // Merge with existing ambulance IDs from hospital registration
      ...
      <div className="min-h-screen bg-lifelink-bg pt-20">
        <div className="w-full px-4 py-8">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
            ...
            <p className="text-yellow-700">You need to register a hospital first to access management features.</p>
          </div>
        </div>
      </div>
    );
